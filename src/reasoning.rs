            ...
            match analysis {
                ...
                "call_graph_stats" => {
                    ...
                    (
                        ...
                        vec!["calls_symbol".into(), "resolved_call".into(), "symbol".into()],
                        "call graph summary statistics over syntactic call edges, compiler-resolved call edges, and project symbols".to_string(),
                        vec![
                            ...
                            "Resolved project callee statistics use compiler-resolved call edges when semantic resolution is available.".into(),
                        ],
                        vec![dependency("snapshot", "actual", data.basis.actual_ts)],
                        "actual",
                    )
